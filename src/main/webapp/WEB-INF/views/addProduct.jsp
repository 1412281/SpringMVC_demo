           ...
           <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
               ...
               <form:form method="POST" modelAttribute="product">
                   ...
                   <div class="form-group">
                       ...
                       <form:input type="text" class="form-control" id="proName" path="proName" placeholder=""/>
                   </div>
                   <div class="form-group">
                       <label for="tinyDes">Describe</label>
                       <form:input type="text" class="form-control" id="tinyDes" path="tinyDes" placeholder=""/>
                   </div>

                   <div class="form-group">
                       <label for="price">Price</label>
                       <form:input type="number" class="form-control" id="price" path="price" placeholder=""/>
                   </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                       ...
                       <form:input type="number" class="form-control" id="quantity" path="quantity" placeholder=""/>
                   </div>
                  <c:choose>
						<c:when test="${edit}">
